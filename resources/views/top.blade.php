						...
						<div class="col-md-3 col-sm-6 wow fadeInLeft animated" data-wow-delay="">
							<div class="product-item">
								<div class="row col-lg-10 col-md-6">
										<a href="/item/detail/{{ $random_item1->id }}" class=" img-responsive shop_modal" width="255" height="322" alt="">
											<div class="card">
													<img src="{{ asset('storage/'.$random_item1->img_1)}}" class="item-img">
													<div class="card-body">
							...
							<div class="product-item">
								<div class="row col-lg-10 col-md-6">
										<a href="/item/detail/{{ $random_item2->id }}" class=" img-responsive shop_modal" alt="">
											<div class="card">
													<img src="{{ asset('storage/'.$random_item2->img_1)}}" class="item-img">
													<div class="card-body">
							...
							<div class="product-item">
								<div class="row col-lg-10 col-md-6">
										<a href="/item/detail/{{ $random_item3->id }}" class=" img-responsive shop_modal" alt="">
											<div class="card">
													<img src="{{ asset('storage/'.$random_item3->img_1)}}" class="item-img">
													<div class="card-body">
							...
							<div class="product-item">
								<div class="row col-lg-10 col-md-6">
										<a href="/item/detail/{{ $random_item4->id }}" class=" img-responsive shop_modal" alt="">
											<div class="card">
													<img src="{{ asset('storage/'.$random_item4->img_1)}}" class="item-img">
													<div class="card-body">
